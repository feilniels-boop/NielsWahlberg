...
// Cal.com inline-embed på plan-siden (samme kalender som /en/thanks).
...
// Cal.com inline-embed init (samme opsætning som /en/thanks).
function calScript() {
  return (
...
function renderPlanPage(lead) {
  ...
  parts.push(
    block(
      ...
      "<p>" + esc(plan.price_and_booking) + "</p>" +
        '<p class="plan-book-sub">Pick a time below — the calendar is live, so you can book right here.</p>' +
  ...
  return (
    ...
    ".plan-book-sub{color:var(--muted);font-size:0.98rem;line-height:1.5;margin:0 0 14px}" +
